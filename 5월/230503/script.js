...
s_Icons.forEach((li) => {
  li.addEventListener("click", (e) => {
    ...
    s_Slider[target].classList.add('on');
    bg.style.backgroundImage = 'url(./img/sec2_bg_'+ target +'.png)';
...
const d2 = d="M585.5 276C367.959 243.273 245 160.5 0.5 20V729H1921V20C1693 -24 1501 6.78688 1312 147.287C1070.85 326.558 758.5 302.027 585.5 276Z";
